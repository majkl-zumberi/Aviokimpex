...
<section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto">
      <div class="flex flex-col text-center w-full mb-20">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">{$_("photos.title", {
            default: "Galleria fotogarfica",
          })}</h1>
        <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Ecco alcune foto ritraenti la nostra azienda e tutto quello che ne fa parte.</p>
      </div>
        ...
        <div class="lg:w-1/3 sm:w-1/2 p-4">
          <div class="flex relative">
            ...
            <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
              <h2 class="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">Descrizione</h2>
              <h1 class="title-font text-lg font-medium text-gray-900 mb-3">Sede centrale</h1>
